defmodule AgentoWeb.Hooks.Observability do
  @moduledoc """
  ...
  Attach via `live_session :default, on_mount: {AgentoWeb.Hooks.Observability, :default}`.
  ...
  def on_mount(:default, _params, _session, socket) do
    ...
    AgentoWeb.WebEvents.emit_mount(socket.view)
  ...
  defp handle_event_hook(event, params, socket) do
    ...
    AgentoWeb.WebEvents.emit_event(event, socket.view, Map.keys(params))

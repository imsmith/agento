defmodule LlmagentWebWeb.ArchitecturalTest do
  @moduledoc """
  ...
  describe "EventBus Bridge" do
    test "bridge process is running" do
      assert Process.whereis(LlmagentWeb.EventBusBridge) != nil
    end
    ...
    test "bridge survives LiveView unmount", %{conn: conn} do
      ...
      assert Process.alive?(Process.whereis(LlmagentWeb.EventBusBridge))
    end
  end
